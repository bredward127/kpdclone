...
const sectionCopy = {
  ...
  "cover-desk": { eyebrow: "05 / Cover desk", title: "Wrap the promise.", description: "Prepare the front, spine, and back cover inputs for a KDP-style full-wrap package. Cover rendering arrives in the next build step.", icon: Ruler, next: "validation", nextLabel: "Review validation" },
  validation: { eyebrow: "06 / Validation", title: "Make it ready to leave.", description: "A future validation pass will check the interior, full-wrap cover, dimensions, approvals, and package manifest before export.", icon: ShieldCheck, next: "exports", nextLabel: "View exports" },
  exports: { eyebrow: "07 / Exports", title: "Take it to the shelf.", description: "Your approved print package will live here as immutable files and a ZIP download once PDF generation is enabled.", icon: CheckCircle2, next: "book-brief", nextLabel: "Return to brief" },
} as const;
